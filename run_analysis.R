# Coursea Project by Holger Speckter (jerebai)
...
# read features but don't convert text labels to factors
...
# Step 1 - Merge the training and the test sets to create one data set together
...
# group by subject and activity and summarise using mean for this
